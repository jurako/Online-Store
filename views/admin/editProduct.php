        ...
        <div id="wrapper">
            <div id="middle" style="background-color: white; margin-top: 180px; padding-top: 5px; padding-bottom: 5px;">
                ...
                <div class="register-form" style="margin-bottom: 0px; border-bottom: 0px; padding: 5px 15px; color: #333333; font-weight: bold;">
                    ...
                    <div style="float: left; margin-right: 30px;"><a href="/OnlineShop/admin/products/edit" style="font-weight: bold; color: #333333;">Редактировать продукты</a></div>
                ...
                <div class="register-form" style="margin-bottom: 0px; margin-top: 0px; padding: 5px 15px; color: #333333; font-weight: bold; border-bottom: 0px;">
                    <div class="reg-label" style="float:left; font-weight: bold; margin-right: 122px;"><a href="/OnlineShop/admin/products/edit/<?php echo $product['id']; ?>"><?php echo $product['name']; ?></a></div>
                </div> 
               <?php }?>
                <div class="links fl">
