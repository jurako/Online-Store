            ...
            <div id="middle" style="background-color: white; margin-top: 180px; padding-top: 5px; padding-bottom: 5px;">
                <div class="options-form">
                    <div class="links fl">
                        ...
                        <a href="/OnlineShop/cabinet/contactinfo">Контактные данные</span></a><span style="margin: 0 7px;">|</span>
                        ...
                        <a href="<?php echo $_SERVER["REQUEST_URI"]; ?>"><span style="font-weight: bold;">Обратная связь</span></a>
                    </div>
                ...
                <div class="register-form">
                    ...
                    <div style="width: 100%; height: auto; text-align: center; font-family: Arial, Helvetica, sans-serif; color: #797878; line-height: 1.8;">
                        <form action="/OnlineShop/cabinet/contact" method="post">
