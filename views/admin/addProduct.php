        ...
        <div id="wrapper">
            <div id="middle" style="background-color: white; margin-top: 180px; padding-top: 5px; padding-bottom: 5px;">
                ...
                <div class="register-form" style="margin-bottom: 0px; border-bottom: 0px; padding: 5px 15px; color: #333333; font-weight: bold;">
                    ...
                    <?php } ?>
                    <div style="float: left; margin-right: 30px; "><a href="/OnlineShop/admin/products/add" style="font-weight: bold; color: #333333;">Добавить продукт</a></div>
                ...
                <div class="register-form" style="margin-top: 0px; margin-bottom: 0px;">
                    <?php if ($result): 
                            echo '<p style="background-color: green; color: black;">Товар добавлен!</p>';
                          endif; ?>
                    ...
                    <?php endif; ?>
                    <form action='/OnlineShop/admin/products/add' method='post'>
                        ...
                        <div style=" width: 100%; height: 70px; padding-top: 10px;">
                           ...
                           <div class="reg-label" style="float: left; margin-right: 150px;"><textarea style="width: 350px;" name="productCharact" value='<?php echo $charact; ?>'></textarea></div>
                       </div>      
                        <div style=" width: 100%; height: 70px; padding-top: 10px;">
                           <div class="reg-label" style="float:left; font-weight: bold; margin-right: 182px;">Описание продукта:</div>
                           <div class="reg-label" style="float: left; margin-right: 150px;"><textarea style="width: 350px;" name="productDesc" value='<?php echo $desc; ?>'></textarea></div>
                       </div>       
                        <div style=" width: 100%; height: 30px; padding-top: 10px;">
                        ...
                        <div style=" width: 100%; height: 30px; padding-top: 10px;">
                           ...
                           <div class="reg-label" style="float: left; margin-right: 150px;">
                               <select style="width: 150px; " id="prodNames" name="productCategory" class="prodNames">   
                                <?php $productNames = Filter::getProductNames($categoryInfo[0]['category_id']);?>
                                    <?php if (empty($category) || $category == '--Категории--') { echo '<option selected="selected" value="0">--Категории--</option>'; } ?>
                        ...
                        <div style=" margin-top: 20px; width: 100%; height: 30px; padding-top: 10px;">
                           <div class="reg-label" style="float:left; font-weight: bold; margin-right: 226px;"><input style="width: 150px;" type="submit" name="submitAddProduct" value='СОХРАНИТЬ' class="add_to_cart_btn"></div>
                       </div>                         
                    </form>
                </div>
