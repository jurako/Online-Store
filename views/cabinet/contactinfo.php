            ...
            <div id="middle" style="background-color: white; margin-top: 180px; padding-top: 5px; padding-bottom: 5px;">
                <div class="options-form">
                    <div class="links fl">
                        ...
                        <a href="<?php echo htmlentities($_SERVER["REQUEST_URI"]); ?>"><span style="font-weight: bold;">Контактные данные</span></a><span style="margin: 0 7px;">|</span>
                        ...
                        <a href="/cabinet/contactshop">Обратная связь</a><span style="margin: 0 7px;">|</span>
                        <?php if(User::getRole($_SESSION["userId"]) == 1) { ?>
                           <a href="/admin/users/add">Панель администратора</a>
                        <?php } elseif(User::getRole($_SESSION["userId"]) == 2) { ?>
                           <a href="/admin/products/add">Панель администратора</a>
                        <?php } ?>
                    </div>
